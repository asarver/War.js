...
Deck.prototype.createDeck = function() {
  ...
  for (var suit = 1; suit <= 4; ++suit) {
    ...
    for (var value = 1; value <= 13; ++value) {
      if (suit == 1) {
        this.myDeck[deckIndex] = new Card(value, "Hearts");
      } else if (suit == 2) {
			  this.myDeck[deckIndex] = new Card(value, "Clubs");
			} else if (suit == 3) {
			  this.myDeck[deckIndex] = new Card(value, "Diamonds");
			} else {
			  this.myDeck[deckIndex] = new Card(value, "Spades");
		  }
			++deckIndex;
    }
  }
